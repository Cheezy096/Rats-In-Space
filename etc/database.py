...
def prepare():
    ...
    cursor.execute("CREATE TABLE IF NOT EXISTS 'posts' ('content' TEXT NOT NULL, 'msg_id' INTEGER NOT NULL, 'board_id' INTEGER NOT NULL, 'thread_id' INTEGER NOT NULL)")
    ...
    cursor.execute("CREATE TABLE IF NOT EXISTS `users` ('username'	TEXT NOT NULL, 'password' TEXT NOT NULL, 'id' INTEGER NOT NULL, 'type' INTEGER NOT NULL);")
